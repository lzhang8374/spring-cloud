package com.aderi.springbatch.task.job;

import com.aderi.springbatch.entity.Student;
import com.aderi.springbatch.task.listener.JobListener;
...
public class DataBatchJob {
    ...
    private ItemProcessor<Student, Student> getDataProcessor() {
        return student -> {
            // 模拟处理数据，这里处理就是打印一下
            System.out.println("processor data : " + student.toString());
            return student;
        };
    }
    ...
    private ItemWriter<Student> getDataWriter() {
        return list -> {
            for (Student student : list) {
                ...
                System.out.println("write data : " + student);
            }
        };
    }
